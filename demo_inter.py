...
class Demo():
    ...
    def plot_video(self, video, outputs, num_queries, start_tracking_frames):
        ...
        video_plotted = draw_tracks_on_video(video, pred_locations, pred_occluded, start_tracking_frames, mode="rainbow", tracks_leave_trace=1)
...
with gr.Blocks(title="TAPTR") as demo:
    title_markdown = ("""
        ...
        [[Project Page]](https://taptr.github.io) [[Paper]](https://arxiv.org/abs/2407.16291) [[Code]](https://github.com/IDEA-Research/TAPTR)
    """)
    tips = ("""
        **Usage** \\
...
# CUDA_VISIBLE_DEVICES=1 python demo_inter.py -c config/TAPTRv2_CaUpAware.py --path_ckpt logs/TAPTRv2_CaUpAware_rerun2/checkpoint0116.pth