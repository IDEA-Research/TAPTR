    ...
    with gr.Row():
        with gr.Column(scale=0.5):
            ...
            if os.path.exists("./assets/VideoEditing.mp4"):
                example_video = gr.Video(label="Example Video", height=250, value="./assets/VideoEditing.mp4")
                gr.Markdown(tips)
        with gr.Column():
            interaction = gr.ImageMask(type='numpy', interactive=True, height=600)
            output_video = gr.Video(label="Out Video", height=600)
