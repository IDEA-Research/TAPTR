...
#* Additional for TAPTRv3

# set it as the inverse of crop_size
eval_scale = [512, 384]

# not track the invisible points during training
not_track_invisible = True

# CCA
use_cca_in_apu = (2, 1)

# VLSA
decoder_module_seq = ['lta', 'ca', 'sa', 'ffn']
visibility_aware_in_lta = True
use_lta_and_no_content_padding = True
