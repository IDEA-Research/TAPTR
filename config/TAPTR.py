...
add_corr_block = True
corr_once = True
fix_decoder_unsync = True
ignore_outsight = True
# for unrolled temporal 
sliding_window_size = 8
sliding_window_stride = 4
add_temporal_embedding = False
multi_layer_full_seq = True
update_query_between_window_mode = "mlp_delta_with_init"
dropout_update_query_between_window = 0.6
# for losses
