...
def main(args):
    ...
    args.dataset_file = getattr(args, 'dataset_file', 'kubric')
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
            ...
            lr_scheduler._last_lr = checkpoint['lr_scheduler']["_last_lr"]
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('ParticleDINO training script', parents=[get_args_parser()])
